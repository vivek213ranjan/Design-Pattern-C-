...
public:
    ...
    void fire(float direction) {
        ...
        cout << "Damagepower: " << _damagePower << endl;
...
public:
    SimpleBullet(string bulletName, float speed, float firePower, float damangePower):
            Bullet(bulletName, speed, firePower, damangePower) {}
    unuique_ptr<Bullet> clone() override {
...
public:
    GoodBullet(string bulletName, float speed, float firePower, float damangePower):
            Bullet(bulletName, speed, firePower, damangePower) {}
    unuique_ptr<Bullet> clone() override {
